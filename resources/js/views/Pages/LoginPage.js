...
const LoginPage = (props) => {
  ...
  return (
    <div className={classes.container}>
            ...
            <Card login className={classes[cardAnimaton]}>
              ...
              <CardBody>
                <form>
                  ...
                  <span>	パスワードを忘れた方は <a href="/auth/recoverpass-page" style={{ color: "red", fontWeight: "bold" }}>こちら</a></span>
                  </div>
                </form>
              </CardBody>
            </Card>
      ...
      <div style={{ textAlign: "center" }}>
        <p>	サービスのご利用には会員登録が必要です<br/>会員登録は <a href="/auth/register-page" style={{ color: "red", fontWeight: "bold" }}>こちら</a>
</p>
      </div>
    </div>
  );
